...
public class FuelSim {
    public static final double PERIOD = 0.02; // sec
    ...
    private static final double FUEL_COR = 0.4; // coefficient of restitution with another fuel
    ...
    private static final double FRICTION = 2; // proportion of horizontal velocity to lose per second while on ground
